...
def definiteness(matrix):
    ...
    Returns:
        String indicating the definiteness: 'Positive definite', 'Positive semi-definite',
    ...
    try:
        ...
        # Handle complex eigenvalues (shouldn't happen for symmetric matrices, but just in case)
